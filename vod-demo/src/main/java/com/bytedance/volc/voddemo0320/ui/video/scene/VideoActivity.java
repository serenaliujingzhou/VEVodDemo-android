...
package com.bytedance.volc.voddemo0320.ui.video.scene;
...
import com.bytedance.volc.voddemo0320.ui.video.scene.feedvideo.FeedVideoFragment;
import com.bytedance.volc.voddemo0320.ui.video.scene.fullscreen.FullScreenVideoFragment;
import com.bytedance.volc.voddemo0320.ui.video.scene.longvideo.LongVideoFragment;
import com.bytedance.volc.voddemo0320.ui.video.scene.shortvideo.ShortVideoFragment;
...
//        }
    ...
    private Fragment createFragment(int scene, Bundle bundle) {
        switch (scene) {
            ...
            case SCENE_LONG: {
                DetailVideoFragment fragment = DetailVideoFragment.newInstance();
//                fragment.set(mDetailVideoSceneEventListener);
                return fragment;
            }
            case SCENE_DETAIL: {
